        ...
        components={{
          ...
          code: ({ className, children, node, ...rest }) => {
            ...
            */
            ...
            if (fenced) {
              return (
                <code
                  className="block font-mono text-[14px] leading-relaxed text-ink-dim"
                  {...rest}
                >
                  {children}
                </code>
            ...
            return (
              <code
                className="rounded bg-code/12 px-1 py-0.5 font-mono text-[13.5px] text-code"
                {...rest}
              >
                {children}
              </code>
          ...
          table: (p) => (
            <div className="my-3 overflow-x-auto rounded-card border border-line">
              <table className="w-full border-collapse text-[14px]" {...dom(p)} />
            </div>
          ),
