...
const SIZE_CLASS = { sm: "text-[14px]", md: "text-[15px]" } as const;
  ...
  return (
    <div className={cx(SIZE_CLASS[size], "leading-relaxed tracking-[0.005em]", TONE_CLASS[tone])}>
      <ReactMarkdown
        ...
        components={{
          h1: (p) => <h1 className="mb-3 mt-6 text-[19.5px] font-bold text-ink" {...dom(p)} />,
          h2: (p) => <h2 className="mb-2 mt-6 text-[17px] font-bold text-ink" {...dom(p)} />,
          h3: (p) => <h3 className="mb-1.5 mt-5 text-[14.5px] font-semibold text-ink" {...dom(p)} />,
          h4: (p) => <h4 className="mb-1.5 mt-4 text-[13.5px] font-semibold text-ink" {...dom(p)} />,
          ...
          code: ({ className, children, node, ...rest }) => {
            ...
            */
            ...
            if (fenced) {
              return (
                <code
                  className="block font-mono text-[13px] leading-relaxed text-ink-dim"
                  {...rest}
                >
                  {children}
                </code>
            ...
            return (
              <code
                className="rounded bg-code/12 px-1 py-0.5 font-mono text-[12.5px] text-code"
                {...rest}
              >
                {children}
              </code>
          ...
          table: (p) => (
            <div className="my-3 overflow-x-auto rounded-card border border-line">
              <table className="w-full border-collapse text-[13px]" {...dom(p)} />
            </div>
          ),
